...
careers_schedule_now = driver.find_element_by_xpath("/html/body/div[5]/div/div[2]/div/div/div/div/div/div/div/div/span/div[2]/div/div/p[2]/span/span/span/a").click()
time.sleep(10)
